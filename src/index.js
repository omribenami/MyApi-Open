...
const oauthAdapters = {
  ...
  instagram: new GenericOAuthAdapter({
    ...
    verifyUrl: 'https://graph.instagram.com/v19.0/me?fields=id,username',
  ...
  microsoft365: new GenericOAuthAdapter({
    ...
    scope: process.env.MICROSOFT365_SCOPE || 'openid profile email offline_access User.Read',
  ...
  hubspot: new GenericOAuthAdapter({
    ...
    scope: process.env.HUBSPOT_SCOPE || 'oauth crm.objects.contacts.read',
  ...
  jira: new GenericOAuthAdapter({
    ...
    scope: process.env.JIRA_SCOPE || 'read:jira-user read:jira-work offline_access',

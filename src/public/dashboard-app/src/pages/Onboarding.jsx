...
const ALL_SCOPES = [
  { id: 'knowledge:read',  label: 'Knowledge read',   write: false },
  { id: 'services:read',   label: 'Services read',    write: false },
  { id: 'personas:read',   label: 'Personas read',    write: false },
  { id: 'skills:read',     label: 'Skills read',      write: false },
  { id: 'services:write',  label: 'Services write',   write: true  },
  { id: 'knowledge:write', label: 'Knowledge write',  write: true  },
];

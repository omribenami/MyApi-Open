// MyApi Open: organization management (B2B) is part of the hosted MyApi Cloud
// edition. This stub keeps the /organization route building and rendering a
  ...
  return (
    <div style={{ maxWidth: 480, margin: '48px auto', textAlign: 'center', padding: 24 }}>
      ...
      <p style={{ fontSize: 13.5, opacity: 0.75, margin: 0 }}>
        Organization management (teams, domains, SSO, SCIM, org policies) is part of the
